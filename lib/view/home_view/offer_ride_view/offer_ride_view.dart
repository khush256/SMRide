...
import 'package:smride_app/view/home_view/offer_ride_view/widgets/not_registered.dart';

import 'package:smride_app/view_model/home_view_model.dart';
import 'widgets/rideRequestList.dart';
...
class _OfferRideState extends State<OfferRide> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<HomeViewModel>().isCarRegistered();
    });
  }
